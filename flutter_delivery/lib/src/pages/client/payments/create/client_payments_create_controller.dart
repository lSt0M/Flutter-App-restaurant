...
import 'package:flutter_delivery/src/provider/mercado_pago_provider.dart';
...
class ClientPaymentsCreateController {
  ...
  void createCardToken() async {
    ...
    if (expireDate.isEmpty) {
      MySnackbar.show(context, 'Ingresa le fecha de expiración de la tarjeta');
      return;
    }
    ...
    if (expireDate != null) {
      ...
      if (list.length == 2) {
        ...
        expirationYear = '23${list[1]}';
      }
      else {
        MySnackbar.show(context, 'Inserta el mes y el año de expiración de la tarjeta');
      }
    }
    ...
    if (response != null) {
      ...
      if (response.statusCode == 201) {
        ...
        int status = int.tryParse(data['couse'][0]['code'] ?? data['status']);
